...
const sources: ApartmentSource[] = [
  ...
  /* ---------------------------------------------------------- 4. GUADELOUPE */
  {
    ...
    region: "guadeloupe",
    status: "complete",
    // Galerie complète : 39 photos (sources hors dépôt, dans
    // Assets/petites-barques/photos-originales/guadeloupe/), numérotées dans
    // l'ordre d'affichage choisi. `galleryAlts` : une description par photo,
    // même ordre.
    gallery: [
