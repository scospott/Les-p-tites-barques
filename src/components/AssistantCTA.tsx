...
/* ------------------------------------------------------------------
   ...
   Carte portrait (4:5, 720 px max) sur fond de vagues : titre + ornement en
   haut, puis en bas un encadré de chat crème qui réunit le champ de saisie
   et, dessous, les questions suggérées. La conversation se déroule ici même
